    ...
    <header id="header" class="fixed-top d-flex align-items-center">
      <div class="container d-flex align-items-center justify-content-between">
        ...
        <nav id="navbar" class="navbar" v-bind:class="(showMobileMenu) ? 'navbar-mobile' : ''">
          <ul>
            <li>
              <nuxt-link :class="{ 'active-link': isActive('/#hero') }" to="#hero">Accueil</nuxt-link>
            </li>
            <li>
              <nuxt-link :class="{ 'active-link': isActive('/#about') }" to="#about">Qui sommes-nous ?</nuxt-link>
            </li>
            <li>
              <nuxt-link :class="{ 'active-link': isActive('/#services') }" to="#services">Services</nuxt-link>
            </li>
            <li>
              <nuxt-link :class="{ 'active-link': isActive('/#portfolio') }" to="#portfolio">Nos Réalisations</nuxt-link>
            </li>
            <li>
              <nuxt-link :class="{ 'active-link': isActive('/#team') }" to="#team">NOTRE ÉQUIPE</nuxt-link>
            </li>
            <li>
              <nuxt-link :class="{ 'active-link': isActive('/#contact') }" to="#contact">Contact</nuxt-link>
            </li>
...
export default {
  ...
  methods: {
    isActive(route) {
      ...
      // Use this method to determine if the current route matches the provided route
